...
namespace COMIGHT
{
    ...
    public static class Settings
    {
        ...
        //public static readonly string websitesJsonFilePath = Path.Combine(appPath, "Websites.json"); //获取网址Json文件路径
        public static readonly string appSettingsJsonFilePath = Path.Combine(appPath, "AppSettings.json"); //获取应用程序设置Json文件路径
        public static readonly string userRecordsJsonFilePath = Path.Combine(appPath, "UserRecords.json"); //获取用户使用记录Json文件路径
