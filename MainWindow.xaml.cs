...
namespace COMIGHT
{
    ...
    public partial class MainWindow : Window
    {
        ...
        private void MnuBatchDisassembleExcelWorkbook_Click(object sender, RoutedEventArgs e)
        {
            BatchDisassembleExcelWorkbook();
        }
        ...
        public void BatchDisassembleExcelWorkbook()
        {
            try
            {
                // 定义功能选项列表
